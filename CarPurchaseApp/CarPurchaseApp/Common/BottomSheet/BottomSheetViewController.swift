...
//  Brollert
//
//  Created by Simelabs on 26/09/24.
//
...
class BottomSheetViewController: UIViewController {
    ...
    private func setupViews() {
        ...
        NSLayoutConstraint.activate([
            contentView.leadingAnchor.constraint(equalTo: mainContainerView.leadingAnchor, constant: 5),
            contentView.trailingAnchor.constraint(equalTo: mainContainerView.trailingAnchor, constant: -5),
