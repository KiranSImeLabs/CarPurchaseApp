...
//
//   let carDetailModel = try? JSONDecoder().decode(CarDetailModel.self, from: jsonData)
...
struct PerformanceSpecs: Codable {
    let mileage, odometer, fuelType, maximumSpeed: String
    let weightToPowerRatio, weightToTorqueRatio: String
}
